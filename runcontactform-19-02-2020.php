...
$formproc->AddRecipient('rushi@premierfoodsupplies.com,info@premierfoodsupplies.com,ridhisha@premierfoodsupplies.com,supriya@optimist.co.in'); //<<---Put your email address here
	   ...
	   <div><br>
		...
		<div>
	     ...
	     <div class="form-group name-group">
          ...
          <textarea rows="40" cols="20" name='message' class="form-control" id="validationCustom05" id='message' required  maxlength="50"></textarea>
	   ...
	   <div><br>
		...
		<div>
	     ...
	     <div class="form-group name-group">
          ...
          <textarea rows="40" cols="20" name='phone' class="form-control" id="validationCustom05" id='message' required  maxlength="50"></textarea>
		<div class="invalid-feedback">
          Please provide a message.
        </div>
			 	 <span id='contactus_message_errorloc' class='error'></span>	
...
//	frmvalidator.addValidation("website","req","Please provide your website");
    frmvalidator.addValidation("message","req","The message is too long!(more than 2KB!)");
